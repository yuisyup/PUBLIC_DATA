...
class RegisterCsvView(RegisterViewMixin):
    ...
    def get(self, request: HttpRequest) -> HttpResponse:
        ...
        fields = [
            {
                "name": "input_data_choices",
                "type": "select",
                "label": "入力データ定義",
                "choices": input_def_choices,
            },
            {
                "name": "csv_file",
                "type": "file",
    ...
    def post(self, request: HttpRequest) -> HttpResponse:
        ...
        issue_table: Dict[str, Any] = IssueTableBuilder.build(
            issues=result_issues, include_context=False
        )
        ...
        # 画面表示メッセージ
        self.add_status_message(request=request, result=run_result, run_id=run_id)
