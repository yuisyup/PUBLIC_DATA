...
from common.services.processor.register.normalizer.steps.add_execute_date import AddExecuteDate
...
class NormalizerStepRegistry:
    ...
    def resolve(self, key: str) -> Type[NormalizerStepsProtocol]:
        try:
            ...
            raise NormalizerRegistryError(f"前処理クラスが見つかりません。key: {key}") from e
