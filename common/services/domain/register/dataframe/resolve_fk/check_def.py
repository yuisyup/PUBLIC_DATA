...
class CheckDef:
    ...
    def check(
        ...
        if not (
            spec.input_id and 
            spec.column_order and
            spec.model_target_field_name and
            spec.fk_target_model and 
            spec.fk_target_field and
            spec.fk_lookup_fields and
            spec.input_lookup_fields):
